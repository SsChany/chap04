...
public class StudentData {
	...
	//필드임. 암튼 필드임. 필드의 역할은 데이터 저장
	public Student[] students = new Student[8]; // new -->객체로 생성됨 메모리 공간 확보
	
	// 클래스 이름과 같으면 생성자(파라미터 가없으면 기본생성자)
	public StudentData() {	// 원래 initData 에서 하는일
