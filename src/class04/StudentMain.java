...
public class StudentMain {
	...
	public static void main(String[] args) {
		...
		StudentData sd = new StudentData();		//객체 생성 (new) StudentData : 생성자 호출
	...
	private static void printStudent(Student[] students) {
		...
		System.out.println();
		for (Student student : students) {
			System.out.printf("%s      %s       %s      %d      %s       %d \n",student.getId(),student.getJumin(),student.getName(),student.getYear(),student.getAddress(),student.getDepartment());
		}	
